    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DaySchedule", x => x.DayNumber);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LessonName = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    DayNumber = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Activity", x => x.ActivityNumber);
                    table.ForeignKey(
                        name: "FK_Activity_DaySchedule_DayNumber",
                        column: x => x.DayNumber,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TeacherScheduleId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Lessons", x => new { x.TeacherScheduleId, x.Id });
                    table.ForeignKey(
                        name: "FK_Lessons_TeacherSchedule_TeacherScheduleId",
